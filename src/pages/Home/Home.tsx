...
const Home: any = () => {
  return (
    <section className="app-row py-10 bg-gray-200 md:pr-6 md:pl-6">
      <div className="container mx-auto">
        ...
        <p>
          I write on a blog here{" "}
          <a href={HomePanel.blog} target="_blank" rel="noopener noreferrer">
            www.themwebs.me
          </a>
        </p>
        <p>
          I enjoy building and designing applications for the web. I enjoy
          working with web technologies such as {HomePanel.tools}. I enjoy
          learning and teaching web development and engineering concepts. I
          enjoy sports'ing football and squash.
        </p>
        <p>
